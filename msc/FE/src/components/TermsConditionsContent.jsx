...
/**
 * TermsConditionsContent - Componente que renderiza el texto legal de los términos de servicio.
 * Mantiene el contenido en español para cumplimiento legal local pero usa nomenclatura en inglés.
 */
function TermsConditionsContent() {
  return (
    <div className="terms-conditions-content-wrapper">
      <h1>TÉRMINOS Y CONDICIONES DE USO</h1>
      <span className="terms-conditions-last-update"><strong>Última actualización:</strong> {(new Date()).toLocaleDateString()}</span>
      ...
      <p className="terms-conditions-footer-note">Al registrarse en la plataforma, el usuario declara haber leído, comprendido y aceptado en su totalidad estos Términos y Condiciones.</p>
    </div>
  );
}
