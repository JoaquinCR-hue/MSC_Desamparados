...
// Importación de logotipos locales
...
// Logotipos remotos para instituciones públicas de Costa Rica
...
// Componente para visualizar el directorio de números de emergencia y servicios públicos
const EmergencyDirectory = () => {
    const [filter, setFilter] = React.useState('TODOS');
    const [brokenLogos, setBrokenLogos] = React.useState(new Set());

    // Maneja errores de carga de imágenes reemplazándolas con íconos por defecto
            ...
            <div className="dashboard-layout">
                <aside className="dashboard-sidebar">
                    <nav className="sidebar-nav">
                        ...
                        <a href="/emergencies" className="sidebar-item active">
                            <i className="fa-solid fa-address-book"></i>
                            <span>Directorio</span>
                        </a>
                        <a href="/risk-map" className="sidebar-item">
