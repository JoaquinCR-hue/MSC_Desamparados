...
// Componente para actualizar el centro del mapa de forma suave
...
const ReportarIncidente = () => {
  ...
  // Centro de Costa Rica con más acercamiento por defecto
  ...
  const handleChange = (e) => {
    ...
    if (name === "distrito") {
      setFormData({
        ...formData,
        [name]: value,
        barrio: "" // reseteamos el barrio al cambiar distrito
      });
      // Actualizamos el mapa si tiene valor
          ...
          <div className="report-content-grid">
            ...
            <div className="map-container-wrapper">
              <MapContainer center={mapCenter} zoom={mapZoom} scrollWheelZoom={true} className="leaflet-map">
                {/* Tema claro estándar recomendado */}
                <TileLayer 
