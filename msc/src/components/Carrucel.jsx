...
function Carrucel() {
  return (
    <Carousel>
      <Carousel.Item>
        <img src="../src/Img/mapa_desamparados_generado.png" alt="First slide" className="d-block w-100" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src="../src/Img/carrucel_2_hiq.png" alt="Second slide" className="d-block w-100" />
        <Carousel.Caption>
      ...
      <Carousel.Item>
        <img src="../src/Img/carrucel_1.jpg" alt="Third slide" className="d-block w-100" />
        <Carousel.Caption>
