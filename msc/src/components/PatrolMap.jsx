  ...
  return (
    <div className="patrol-map-wrapper">
      <div className="alert-banner-info mb-3">
        <i className="fa-solid fa-circle-info"></i> <strong>Instrucciones:</strong> Haz clic en cualquier parte del mapa para asignar una nueva patrulla a esas coordenadas. Haz clic en las patrullas existentes (escudos) para editar o retirar unidades.
      </div>
